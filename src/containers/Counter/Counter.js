...
const matchDispatchToProps = dispatch => {
    return {
        ...
        onSubtractCounter: () => dispatch({type: actionsType.SUBTRACT, value: 5}),
        onStoreResult: (ctr) => dispatch({type: actionsType.STORE_RESULT, counter: ctr}),
        onDeleteResult: (id) => dispatch({type: actionsType.DELETE_RESULT, resultElId: id})
    }
}
